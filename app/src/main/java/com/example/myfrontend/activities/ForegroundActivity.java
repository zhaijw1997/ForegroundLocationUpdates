 ...
 */
public class ForegroundActivity extends AppCompatActivity implements
        SharedPreferences.OnSharedPreferenceChangeListener {
    private static final String TAG = ForegroundActivity.class.getSimpleName();
    ...
    private void requestPermissions() {
        ...
        if (shouldProvideRationale) {
            ...
            Snackbar.make(
                    findViewById(R.id.activity_foreground),
                    ...
                    .setAction(R.string.ok, new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            // Request permission
                            ActivityCompat.requestPermissions(ForegroundActivity.this,
    ...
    private class MyReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (location != null) {
                Toast.makeText(ForegroundActivity.this, Utils.getLocationText(location),
