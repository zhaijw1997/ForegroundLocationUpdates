...
public class Test2Activity extends AppCompatActivity {
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(Test2Activity.this, REQUEST_CHECK_SETTINGS);
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(Test2Activity.this, errorMessage, Toast.LENGTH_LONG).show();
                                mRequestingLocationUpdates = false;
                        }
    ...
    private double calculateDistance(double lat1, double lng1, double lat2,double lng2){
        double s = LocationUtils.getDistance(lat1,lng1,lat2,lng2);
        return s;
    }
    ...
    private void updateLocationUI() {
        if (mCurrentLocation != null) {
            ...
            mDistanceTextView.setText(String.format(Locale.ENGLISH,"%s: %f", mDistanceLabel,
                    calculateDistance(mCurrentLocation.getLatitude(),mCurrentLocation.getLongitude(),53.8072761,1.5545049)));
        }
    }
